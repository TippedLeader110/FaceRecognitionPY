...
Modified by TippedLeader110 - Muhammad Bayhaqi Daulay
'''
...
eyeCascade = cv2.CascadeClassifier(cv2.data.haarcascades + eyecasc)
smilecasc= "haarcascade_smile.xml"
smileCascade = cv2.CascadeClassifier(cv2.data.haarcascades + smilecasc)
